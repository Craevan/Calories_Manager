...
public class MatcherFactory {
    ...
    public static <T> Matcher<T> usingIgnoringFieldComparator(Class<T> clazz, String... fieldsToIgnore) {
    ...
    public static class Matcher<T> {
        ...
        public final void assertMatch(Iterable<T> actual, Iterable<T> expected) {
